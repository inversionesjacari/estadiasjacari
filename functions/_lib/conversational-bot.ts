...
6. ⚠️ TAMPOCO es out_of_scope (estos pasan MUY seguido y mandarlos al "no contamos con esa opción / otras zonas" MATA la venta — es un error grave):
   ...
   En resumen: out_of_scope es SOLO otra ZONA o un SERVICIO que no damos — JAMÁS una objeción de precio, una duda de capacidad, una despedida, ni alguien que describe lo que busca (cocinar, reunirse, descansar).
